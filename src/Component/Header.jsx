...
function Header() {
  ...
  return (
    <div className={isDarkTheme ? "header dark-theme" : "header light-theme"}>
      ...
      <div className="content-header">
        <div className="flex-headline-header">
          <div
            className={
              isDarkTheme
                ? "headline-header dark-text"
                : "headline-header light-text"
            }
          >
            Work
          </div>
          <div className="headline-header second-headline-header">fast</div>
        </div>
