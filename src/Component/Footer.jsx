...
import imagesFooter from "../image/image-footer2.svg";
import mapsFooter from "../image/mapsFooter.svg";
import mapsFooterTablet from "../image/mapFooter-tablet.svg";
    ...
    >
      <div className="block-images-footer">
        ...
        <img
          src={imageFooter}
          alt="footer-image"
          className="images-footer images-footer-mobile"
        ></img>

        <img
          src={imagesFooter}
          alt="footer-image"
          className="images-footer images-footer-tablet"
        ></img>
      </div>
      <img
        src={mapFooter}
        alt="map-footer"
        className="  maps-footer-mobile"
      ></img>
      <img
        src={mapsFooterTablet}
        alt="map-footer"
        className="maps-footer-tablet"
      ></img>
      <img
        src={mapsFooter}
        alt="map-footer"
        className="maps-footer-desctop"
      ></img>
      <div
        className={
          isDarkTheme
      ...
      >
        <div className="flex-footer-description">
